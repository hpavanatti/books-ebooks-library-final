(function () {
    ...
    SocialListController.$inject = ['SocialService', 'DialogBuilder']

    function SocialListController(SocialService, DialogBuilder) {
        var vm = this;
        vm.data = {};
        vm.filtro = '';
        vm.page = {
        ...
        function load() {
            SocialService.findAll(vm.filtro, vm.page)
                .then(function (dados) {
                    vm.data = dados
                });
        }
