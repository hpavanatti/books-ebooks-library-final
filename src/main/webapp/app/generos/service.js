(function () {
    ...
    function GeneroService($http) {
        ...
        function findAllOver() {
            return $http.get('http://localhost:8080/api/generos/all?order=nome')
        ...
        function findAll(filtro, page) {
            return $http.get('http://localhost:8080/api/generos?page=' + page.number +
        ...
        function findById(id) {
            return $http.get('http://localhost:8080/api/generos/' + id)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function insert(registro) {
            return $http.post('http://localhost:8080/api/generos', registro)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function update(registro) {
            return $http.put('http://localhost:8080/api/generos/' + registro.id, registro)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function remove(id) {
            return $http.delete('http://localhost:8080/api/generos/' + id)
                .then(function (response) {
                    return response.data;
                });
        }
